...
function Frame4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px min-w-px not-italic relative">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] overflow-hidden relative shrink-0 text-[16px] text-[rgba(255,255,255,0.9)] text-ellipsis w-full">Carbon monoxide alarms should be installed on every level of the home and in sleeping areas.</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[24px] h-[440px] items-end justify-center p-[24px] relative rounded-[16px] shrink-0 w-[648px]">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[16px]">
        <img alt="" className="absolute max-w-none object-cover rounded-[16px] size-full" src={imgFrame2117131978} />
