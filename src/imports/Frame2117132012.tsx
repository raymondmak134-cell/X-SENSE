...
import imgFrame2117131981 from "@/assets/placeholder-image-url";
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px min-w-px not-italic relative">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[34px] relative shrink-0 text-[24px] text-white w-full">How to Choose a Heat Alarm</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] overflow-hidden relative shrink-0 text-[16px] text-[rgba(255,255,255,0.9)] text-ellipsis w-full">Learn more about how to choose a heat alarm.</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="h-[440px] relative rounded-[16px] shrink-0 w-[205.333px]">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[16px] size-full" src={imgFrame2117131981} />
    </div>
  );
}
