import svgPaths from "./svg-gq5o18jer6";
...
import imgProductImage3 from "@/assets/placeholder-image-url";
import imgProductImage4 from "@/assets/placeholder-image-url";
import imgProductImage5 from "@/assets/placeholder-image-url";
...
import imgImage4 from "@/assets/placeholder-image-url";
import imgImage5 from "@/assets/placeholder-image-url";
...
function TextContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-center w-[353px]" data-name="Text Container">
...
function Image() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[262px] items-center justify-center left-0 overflow-clip p-[20px] right-0 top-[48px]" data-name="Image">
...
function Product() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-h-px min-w-[168.5px] relative" data-name="Product">
      <div className="relative shrink-0 size-[168.5px]" data-name="Product Image">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgProductImage} />
      </div>
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-black text-center w-[min-content]">Smoke Alarms</p>
    </div>
  );
}
...
function Product1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-h-px min-w-[168.5px] relative" data-name="Product">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-black text-center w-[min-content]">CO Alarms</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-h-px min-w-[168.5px] relative" data-name="Product">
      <div className="relative shrink-0 size-[168.5px]" data-name="Product Image">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute left-[15.56%] max-w-none size-[68.66%] top-[15.44%]" src={imgProductImage2} />
        </div>
      </div>
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-black text-center w-[min-content]">Combination Alarms</p>
    </div>
  );
}
...
function Product3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-h-px min-w-[168.5px] relative" data-name="Product">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-black text-center w-[min-content]">Home Alarms</p>
    </div>
  );
}
...
function Product4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-h-px min-w-[168.5px] relative" data-name="Product">
      <div className="relative shrink-0 size-[168.5px]" data-name="Product Image">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgProductImage4} />
      </div>
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-black text-center w-[min-content]">Hub / Base Station</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-h-px min-w-[168.5px] relative" data-name="Product">
      <div className="relative shrink-0 size-[168.5px]" data-name="Product Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgProductImage4} />
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgProductImage5} />
        </div>
      </div>
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-black text-center w-[min-content]">Accessories</p>
    </div>
  );
}
...
function ProductList() {
  return (
    <div className="content-center flex flex-wrap gap-[16px_0px] items-center relative shrink-0 w-full" data-name="Product List">
      <Product />
      <Product1 />
      <Product2 />
      <Product3 />
  ...
  return (
    <div className="relative shrink-0 size-[40px]" data-name="Icon Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g id="Icon Container">
          <rect fill="var(--fill-0, white)" height="40" rx="12" width="40" />
          <rect height="39" rx="11.5" stroke="var(--stroke-0, black)" strokeOpacity="0.1" width="39" x="0.5" y="0.5" />
          <g id="Vector">
            <path d={svgPaths.p1131600} fill="#101820" />
            <path d={svgPaths.p12e96100} fill="var(--fill-0, #BA0020)" />
          </g>
        </g>
      </svg>
    </div>
...
function Container3() {
  return (
    <div className="flex-[1_0_0] h-[168.5px] min-h-px min-w-px relative" data-name="Container">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-start justify-center pr-[32px] relative size-full">
          <IconContainer />
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-black w-[min-content]">Connect to the App</p>
...
function Container2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-[318px] overflow-clip relative rounded-[16px]" data-name="Container" style={{ backgroundImage: "linear-gradient(90deg, rgb(246, 246, 246) 0%, rgb(246, 246, 246) 100%), linear-gradient(90deg, rgba(94, 127, 156, 0.1) 0%, rgba(94, 127, 156, 0.1) 100%)" }}>
      <div className="relative shadow-[-38px_52px_18px_0px_rgba(0,0,0,0),-25px_33px_17px_0px_rgba(0,0,0,0.01),-14px_19px_14px_0px_rgba(0,0,0,0.05),-6px_8px_10px_0px_rgba(0,0,0,0.09),-2px_2px_6px_0px_rgba(0,0,0,0.1)] shrink-0 size-[168.5px]" data-name="Image">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 overflow-clip size-[32px] top-1/2" data-name="Icon">
        <div className="absolute inset-[4.33%_3.43%_5%_5%]" data-name="Union">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 29.3039 29.0135">
            <path d={svgPaths.p2e621380} fill="var(--fill-0, black)" fillOpacity="0.9" id="Union" />
          </svg>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] h-[168.5px] min-h-px min-w-px relative" data-name="Container">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-start justify-center pr-[32px] relative size-full">
          <IconContainer1 />
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-black w-[min-content]">{`Setup & Installation`}</p>
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] min-w-full not-italic relative shrink-0 text-[#5e0000] text-[14px] w-[min-content]">{`Learn More >`}</p>
        </div>
      </div>
    </div>
...
function Container4() {
  return (
    <div className="bg-[rgba(94,127,156,0.1)] content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-[318px] overflow-clip relative rounded-[16px]" data-name="Container">
      <div className="relative shadow-[-38px_52px_18px_0px_rgba(0,0,0,0),-25px_33px_17px_0px_rgba(0,0,0,0.01),-14px_19px_14px_0px_rgba(0,0,0,0.05),-6px_8px_10px_0px_rgba(0,0,0,0.09),-2px_2px_6px_0px_rgba(0,0,0,0.1)] shrink-0 size-[168.5px]" data-name="Image">
          ...
          <div className="-scale-y-100 flex-none h-[23.201px] rotate-180 w-[28.534px]">
            <div className="relative size-full" data-name="Union">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28.7998 23.4658">
                <path d={svgPaths.p395d5700} fill="var(--fill-0, black)" fillOpacity="0.9" id="Union" />
              </svg>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="flex-[1_0_0] h-[168.5px] min-h-px min-w-px relative" data-name="Container">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-start justify-center pr-[32px] relative size-full">
          <IconContainer2 />
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-black w-[min-content]">Order tracking</p>
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] min-w-full not-italic relative shrink-0 text-[#5e0000] text-[14px] w-[min-content]">{`Learn More >`}</p>
        </div>
      </div>
    </div>
...
function Container6() {
  return (
    <div className="bg-[rgba(217,190,161,0.15)] content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-[318px] overflow-clip relative rounded-[16px]" data-name="Container">
      <div className="relative shadow-[-38px_52px_18px_0px_rgba(0,0,0,0),-25px_33px_17px_0px_rgba(0,0,0,0.01),-14px_19px_14px_0px_rgba(0,0,0,0.05),-6px_8px_10px_0px_rgba(0,0,0,0.09),-2px_2px_6px_0px_rgba(0,0,0,0.1)] shrink-0 size-[168.5px]" data-name="Image">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Header1() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-center w-full" data-name="Header">
...
function TextContainer1() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center not-italic relative shrink-0 w-full" data-name="Text Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[18px] text-white w-full">DO NOT use an open flame to test</p>
      <p className="font-['Inter:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[16px] overflow-hidden relative shrink-0 text-[12px] text-[rgba(255,255,255,0.9)] text-ellipsis w-full">{`How to Tell If Your Smoke Alarm is Working？You can test your smoke alarm by pushing the Test/Hush button on the cover and holding it down for a minimum of 5 seconds. `}</p>
    </div>
  );
}
...
function Image1() {
  return (
    <div className="flex-[1_0_0] h-[260px] min-h-px min-w-[318px] relative rounded-[16px]" data-name="Image">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[16px]">
        <img alt="" className="absolute max-w-none object-cover rounded-[16px] size-full" src={imgImage4} />
      ...
      <div className="flex flex-col justify-end min-w-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-end min-w-[inherit] p-[16px] relative size-full">
          <TextContainer1 />
          <div className="bg-white content-stretch flex gap-[4px] items-center justify-center px-[16px] py-[8px] relative rounded-[50px] shrink-0" data-name="原子控件/Mobile/Button/填充Button">
...
function TextContainer2() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center not-italic relative shrink-0 w-full" data-name="Text Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[18px] text-white w-full">Fire and Carbon Monoxide Safety Tips</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] overflow-hidden relative shrink-0 text-[12px] text-[rgba(255,255,255,0.9)] text-ellipsis w-full">Carbon monoxide alarms should be installed on every level of the home and in sleeping areas.</p>
    </div>
  );
}
...
function Image2() {
  return (
    <div className="flex-[1_0_0] h-[260px] min-h-px min-w-[318px] relative rounded-[16px]" data-name="Image">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[16px]">
        <img alt="" className="absolute max-w-none object-cover rounded-[16px] size-full" src={imgImage5} />
        <div className="absolute bg-gradient-to-b from-[rgba(0,0,0,0)] inset-0 rounded-[16px] to-[rgba(0,0,0,0.6)]" />
      </div>
      <div className="flex flex-col justify-end min-w-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-end min-w-[inherit] p-[16px] relative size-full">
...
function TextContainer3() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center not-italic relative shrink-0 w-full" data-name="Text Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[18px] text-white w-full">How to Choose a Heat Alarm</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] overflow-hidden relative shrink-0 text-[12px] text-[rgba(255,255,255,0.9)] text-ellipsis w-full">Learn more about how to choose a heat alarm.</p>
    </div>
  );
}
...
function Image3() {
  return (
    <div className="flex-[1_0_0] h-[260px] min-h-px min-w-[318px] relative rounded-[16px]" data-name="Image">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[16px]">
        <img alt="" className="absolute max-w-none object-cover rounded-[16px] size-full" src={imgImage6} />
        <div className="absolute bg-gradient-to-b from-[rgba(0,0,0,0)] inset-0 rounded-[16px] to-[rgba(0,0,0,0.6)]" />
      </div>
      <div className="flex flex-col justify-end min-w-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-end min-w-[inherit] p-[16px] relative size-full">
...
function TextContainer4() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center not-italic relative shrink-0 w-full" data-name="Text Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[18px] text-white w-full">Fire and Carbon Monoxide Safety Tips</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] overflow-hidden relative shrink-0 text-[12px] text-[rgba(255,255,255,0.9)] text-ellipsis w-full">Protect your home and family from the dangers of fire and carbon monoxide. Install smoke detectors and carbon monoxide</p>
    </div>
  );
}
...
function Image4() {
  return (
    <div className="flex-[1_0_0] h-[260px] min-h-px min-w-[318px] relative rounded-[16px]" data-name="Image">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[16px]">
        <img alt="" className="absolute max-w-none object-cover rounded-[16px] size-full" src={imgImage7} />
        <div className="absolute bg-gradient-to-b from-[rgba(0,0,0,0)] inset-0 rounded-[16px] to-[rgba(0,0,0,0.6)]" />
      </div>
      <div className="flex flex-col justify-end min-w-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-end min-w-[inherit] p-[16px] relative size-full">
...
function Container8() {
  return (
    <div className="content-start flex flex-wrap gap-[16px] items-start justify-center max-w-[1312px] relative shrink-0 w-full" data-name="Container">
      <Image1 />
      <Image2 />
      <Image3 />
      <Image4 />
...
function TitleAndProducts1() {
  return (
    <div className="bg-[#f6f6f6] max-w-[1312px] relative shrink-0 w-full" data-name="Title and Products">
      <div className="content-stretch flex flex-col gap-[24px] items-start max-w-[inherit] px-[20px] py-[32px] relative w-full">
        <Header1 />
        <Container8 />
      </div>
      ...
      <div className="flex flex-col justify-center max-w-[inherit] overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[12px] items-start justify-center max-w-[inherit] p-[16px] relative w-full">
          <div className="h-[119px] relative shrink-0 w-[120px]" data-name="Image">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img alt="" className="absolute h-full left-[-4.12%] max-w-none top-0 w-[135.44%]" src={imgImage8} />
            </div>
          </div>
          <Container10 />
        </div>
...
function Svg7() {
  return (
    <div className="overflow-clip relative shrink-0 size-[24px]" data-name="SVG">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Group">
          <path d={svgPaths.p36f00780} fill="url(#paint0_radial_4146_538)" id="Vector" />
          <path d={svgPaths.p36f00780} fill="url(#paint1_radial_4146_538)" id="Vector_2" />
          <path d={svgPaths.pe918680} fill="var(--fill-0, white)" id="Vector_3" />
        </g>
        <defs>
          <radialGradient cx="0" cy="0" gradientTransform="translate(6.375 25.8485) rotate(-90) scale(23.7858 22.1227)" gradientUnits="userSpaceOnUse" id="paint0_radial_4146_538" r="1">
            <stop stopColor="#FFDD55" />
            <stop offset="0.1" stopColor="#FFDD55" />
            <stop offset="0.5" stopColor="#FF543E" />
            <stop offset="1" stopColor="#C837AB" />
          </radialGradient>
          <radialGradient cx="0" cy="0" gradientTransform="translate(-4.02008 1.7289) rotate(78.68) scale(10.6324 43.827)" gradientUnits="userSpaceOnUse" id="paint1_radial_4146_538" r="1">
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 right-0 top-[310px]">
      <TitleAndProducts />
      <Container1 />
      <TitleAndProducts1 />
      <TitleAndProducts2 />
