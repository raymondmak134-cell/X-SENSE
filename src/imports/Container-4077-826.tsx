import svgPaths from "./svg-ejtn00ygs7";
    ...
    <div className="relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[4px] items-center justify-center pb-[16px] pt-[24px] px-[19px] relative w-full">
          <div className="relative shrink-0 size-[20px]" data-name="power_pc">
            <div className="absolute inset-[4.79%_25.83%_4.38%_25.83%]" data-name="Union">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.78809 18.2275">
                <path d={svgPaths.p34cb7b80} fill="var(--fill-0, black)" fillOpacity="0.9" id="Union" />
              </svg>
            </div>
          </div>
...
function BatteryInfoContainer2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-h-px min-w-px relative" data-name="Battery Info Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[14px] text-[rgba(0,0,0,0.9)] w-full">
...
function BatteryInfoContainer3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-h-px min-w-px relative" data-name="Battery Info Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[14px] text-[rgba(0,0,0,0.9)] w-full">
...
function Info3() {
  return (
    <div className="bg-[#f6f6f6] relative shrink-0 w-full" data-name="info">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center leading-[0] not-italic px-[19px] py-[24px] relative w-full">
          <BatteryInfoContainer2 />
          <BatteryInfoContainer3 />
        </div>
      </div>
    </div>
  );
...
function Frame() {
  return (
    <div className="relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[4px] items-center justify-center pb-[16px] pt-[24px] px-[19px] relative w-full">
          <div className="overflow-clip relative shrink-0 size-[20px]" data-name="功能卖点/智能与连接功能/无线互联警报">
            <div className="absolute inset-[5.01%_5%_4.99%_5%]" data-name="Vector">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9997 17.9997">
                <g id="Vector">
                  <path d={svgPaths.p1debea80} fill="var(--fill-0, black)" />
                  <path d={svgPaths.p2418cb00} fill="var(--fill-0, black)" />
                  <path d={svgPaths.p939bb72} fill="var(--fill-0, black)" />
                  <path d={svgPaths.p35e6fa00} fill="var(--fill-0, black)" />
                  <path d={svgPaths.p14b7ed00} fill="var(--fill-0, black)" />
                </g>
              </svg>
            </div>
          </div>
