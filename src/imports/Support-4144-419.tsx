...
function ProductSupport() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 px-[120px] py-[48px] right-0 top-[1210px]" data-name="Product Support">
      <TitleAndProducts />
    </div>
  );
}
...
function ProductInfo() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 text-center w-full" data-name="Product Info">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[72px] relative shrink-0 text-[56px] text-black w-full">XS0B-MR</p>
...
function Product() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[1312px]" data-name="Product">
      <div className="relative shrink-0 size-[400px]" data-name="Smoke Alarms">
...
function TitleAndProducts1() {
  return (
    <div className="content-stretch flex flex-col items-center max-w-[1312px] relative shrink-0 w-full" data-name="Title and Products">
      <Product />
    </div>
  );
}
...
function ProductSupport1() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 px-[120px] py-[48px] right-0 top-[104px]" data-name="Product Support">
      <TitleAndProducts1 />
    </div>
  );
}
...
function Container29() {
  return (
    <div className="bg-[#f6f6f6] flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[16px]" data-name="Container">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center justify-center px-[32px] relative size-full">
          <IconContainer3 />
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] min-w-full not-italic relative shrink-0 text-[16px] text-black text-center w-[min-content]">{`Setup & Installation`}</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.54)] text-center w-[min-content]">Watch the installation video to quickly set up your alarm detector</p>
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] min-w-full not-italic relative shrink-0 text-[#5e0000] text-[14px] text-center w-[min-content]">{`Learn More >`}</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 overflow-clip size-[40px] top-1/2" data-name="Icon">
        <div className="absolute inset-[5%_21.67%]" data-name="Union">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.666 36">
            <path d={svgPaths.p881f7b1} fill="var(--fill-0, black)" fillOpacity="0.9" id="Union" />
          </svg>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#f6f6f6] flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[16px]" data-name="Container">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center justify-center px-[32px] relative size-full">
          <IconContainer4 />
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] min-w-full not-italic relative shrink-0 text-[16px] text-black text-center w-[min-content]">App</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.54)] text-center w-[min-content]">Official X-SENSE applications with thelatest features.</p>
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] min-w-full not-italic relative shrink-0 text-[#5e0000] text-[14px] text-center w-[min-content]">{`Download >`}</p>
        </div>
      </div>
    </div>
  );
...
function IconContainer5() {
  return (
    <div className="relative shrink-0 size-[56px]" data-name="Icon Container">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+0.33px)] overflow-clip size-[40px] top-[calc(50%-0.34px)]" data-name="icon">
        <div className="absolute inset-[8.09%_10.01%_8.09%_10.02%]" data-name="Union">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.9883 33.5312">
            <path d={svgPaths.pddde900} fill="var(--fill-0, black)" fillOpacity="0.9" id="Union" />
          </svg>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#f6f6f6] flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[16px]" data-name="Container">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center justify-center px-[32px] relative size-full">
          <IconContainer5 />
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] min-w-full not-italic relative shrink-0 text-[16px] text-black text-center w-[min-content]">FAQ</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.54)] text-center w-[min-content]">Browse FAQs and solutions to quickly resolve common issues.</p>
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#5e0000] text-[14px] text-center whitespace-nowrap">{`View Now >`}</p>
        </div>
      </div>
    </div>
  );
...
function Frame() {
  return (
    <div className="absolute left-[8px] size-[40px] top-[8px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g id="Frame">
          <path d={svgPaths.p85a0000} id="Vector" stroke="var(--stroke-0, black)" strokeOpacity="0.9" strokeWidth="2.67" />
          <path d="M10 10H5" id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.9" strokeWidth="2.67" />
          <path d="M10 16.6667H5" id="Vector_3" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.9" strokeWidth="2.67" />
          <path d="M10 23.3333H5" id="Vector_4" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.9" strokeWidth="2.67" />
          <path d="M10 30H5" id="Vector_5" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.9" strokeWidth="2.67" />
          <path d="M35 10H30" id="Vector_6" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.9" strokeWidth="2.67" />
          <path d="M35 16.6667H30" id="Vector_7" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.9" strokeWidth="2.67" />
          <path d="M35 23.3333H30" id="Vector_8" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.9" strokeWidth="2.67" />
          <path d="M35 30H30" id="Vector_9" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.9" strokeWidth="2.67" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="bg-[#f6f6f6] flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[16px]" data-name="Container">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center justify-center px-[32px] relative size-full">
          <IconContainer6 />
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] min-w-full not-italic relative shrink-0 text-[16px] text-black text-center w-[min-content]">Specs</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.54)] text-center w-[min-content]">View product specifications and detailed parameters.</p>
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#5e0000] text-[14px] text-center whitespace-nowrap">{`View Now >`}</p>
        </div>
      </div>
    </div>
...
function Container28() {
  return (
    <div className="content-stretch flex gap-[16px] h-[320px] items-center justify-center max-w-[1312px] relative shrink-0 w-full" data-name="Container">
      <Container29 />
      <Container30 />
      <Container31 />
      <Container32 />
...
function ProductSupport2() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 px-[120px] py-[48px] right-0 top-[702px]" data-name="Product Support">
      <TitleAndProducts2 />
    </div>
  );
}
